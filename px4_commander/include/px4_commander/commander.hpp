        ...
        Commander(rclcpp::Node::SharedPtr node) :
            commander_node(node), frame_(node->get_parameter("frame").as_string()) {
                ...
                auto update_goal = [this](const GoalPoseStampedTy &msg) -> void {
                    ...
                    this->ground_zero_transform_.transform.translation.x = msg.pose.position.x;
                    this->ground_zero_transform_.transform.translation.y = msg.pose.position.y;
                    this->ground_zero_transform_.transform.translation.z = msg.pose.position.z;

                    this->ground_zero_transform_.transform.rotation.x = msg.pose.orientation.x;
                    this->ground_zero_transform_.transform.rotation.y = msg.pose.orientation.y;
                    this->ground_zero_transform_.transform.rotation.z = msg.pose.orientation.z;
                    this->ground_zero_transform_.transform.rotation.w = msg.pose.orientation.w;
